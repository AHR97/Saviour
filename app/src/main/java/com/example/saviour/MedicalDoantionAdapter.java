...
public class MedicalDoantionAdapter extends ArrayAdapter<MedicalDonationListItem> {
     ...
     * @param objects
     */
    public MedicalDoantionAdapter(Context context, int resource, ArrayList<MedicalDonationListItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MedicalDonationListItem person = new MedicalDonationListItem(name,details, contactNumber,total);
