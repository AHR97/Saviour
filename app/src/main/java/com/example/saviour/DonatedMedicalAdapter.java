...
public class DonatedMedicalAdapter extends ArrayAdapter<DonatedMedicalListItem> {
     ...
     * @param objects
     */
    public DonatedMedicalAdapter(Context context, int resource, ArrayList<DonatedMedicalListItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        DonatedMedicalListItem person = new DonatedMedicalListItem(name,details,total,user, givenAmount);
