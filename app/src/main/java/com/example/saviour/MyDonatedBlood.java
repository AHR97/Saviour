...
public class MyDonatedBlood extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_donated_blood);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot contactSnapshot=dataSnapshot.child("My Donations").child(uid).child("Blood Donations");
...
//
//
//                Intent intent=new Intent(GiveABloodDonation.this, MyDonatedBlood.class);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.fabMain:
                ...
                break;
            case R.id.fabOne:
                Intent a=new Intent(MyDonatedBlood.this,MainActivity.class);
                a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(a);
                break;

            case R.id.fabTwo:
                Intent b=new Intent(MyDonatedBlood.this,GiveADonation.class);
                b.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(b);
                break;

            case R.id.fabThree:
                Intent c=new Intent(MyDonatedBlood.this,AskForADonation.class);
                c.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(c);
                break;

            case R.id.fabFour:
                Intent d=new Intent(MyDonatedBlood.this,UserProfile.class);
