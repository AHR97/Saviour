...
public class GiveAnEventDonation extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_give_an_event_donation);
        ...
        final ArrayList<EventDonationListItem> eDonationList = new ArrayList<>();
        final ArrayList<EventDonationListItem> eDonationListMax = new ArrayList<>();

        final ArrayList<String> parentList=new ArrayList<>();

        final EventDonationAdapter adapter=new EventDonationAdapter(this, R.layout.event_donation_listview,eDonationList);


        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot contactSnapshot=dataSnapshot.child("Event Donation Requests");
                ...
                for(DataSnapshot contact : contactChildren){
                    ...
                    EventDonationListItem item= contact.getValue(EventDonationListItem.class);
                    ...
                    if(value<amount)
                    {
                        EventDonationListItem ob=new EventDonationListItem(name, details,number,total,userName);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                EventDonationListItem b=eDonationListMax.get(position);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.fabMain:
                ...
                break;
            case R.id.fabOne:
                Intent a=new Intent(GiveAnEventDonation.this,MainActivity.class);
                a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(a);
                break;

            case R.id.fabTwo:
                Intent b=new Intent(GiveAnEventDonation.this,GiveADonation.class);
                b.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(b);
                break;

            case R.id.fabThree:
                Intent c=new Intent(GiveAnEventDonation.this,AskForADonation.class);
                c.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(c);
                break;

            case R.id.fabFour:
                Intent d=new Intent(GiveAnEventDonation.this,UserProfile.class);
