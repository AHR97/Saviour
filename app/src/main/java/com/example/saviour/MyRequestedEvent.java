...
public class MyRequestedEvent extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_requested_event);
        ...
        final ArrayList<RequestedEventDonationListItem> eDonationList = new ArrayList<>();
        final ArrayList<RequestedEventDonationListItem> eDonationListMax = new ArrayList<>();

        final ArrayList<String> parentList=new ArrayList<>();

        final RequestedEventDonationAdapter adapter=new RequestedEventDonationAdapter(this, R.layout.requested_event_listview,eDonationList);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                DataSnapshot contactSnapshot=dataSnapshot.child("My Requests").child(uid).child("Event Requests");
                ...
                for(DataSnapshot contact : contactChildren){
                    ...
                    RequestedEventDonationListItem item= contact.getValue(RequestedEventDonationListItem.class);
                    ...
                    String collected=item.getCollectedAmount();
                        ...
                        RequestedEventDonationListItem ob=new RequestedEventDonationListItem(name, details,total,collected);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                RequestedEventDonationListItem b=eDonationListMax.get(position);
...
//
//
//                Intent intent=new Intent(MyRequestedEvent.this, DonateOnEvent.class);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.fabMain:
                ...
                break;
            case R.id.fabOne:
                Intent a=new Intent(MyRequestedEvent.this,MainActivity.class);
                a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(a);
                break;

            case R.id.fabTwo:
                Intent b=new Intent(MyRequestedEvent.this,GiveADonation.class);
                b.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(b);
                break;

            case R.id.fabThree:
                Intent c=new Intent(MyRequestedEvent.this,AskForADonation.class);
                c.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(c);
                break;

            case R.id.fabFour:
                Intent d=new Intent(MyRequestedEvent.this,UserProfile.class);
