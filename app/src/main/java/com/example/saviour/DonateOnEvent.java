...
public class DonateOnEvent extends AppCompatActivity implements View.OnClickListener {
    private static final int REQUEST_CALL = 1;
    private String contact, parent, collected, user, name, total,bkash,details, uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donate_on_event);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.HomeButton:
                Intent a = new Intent(DonateOnEvent.this, GiveADonation.class);
            ...
            case R.id.sendMoneyImage:
                ...
                Intent c = new Intent(DonateOnEvent.this, SendEventMoney.class);
    ...
    private void makePhoneCall() {
        ...
        if (number.length() == 11) {
            ...
            if (ContextCompat.checkSelfPermission(DonateOnEvent.this,
                    Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(DonateOnEvent.this,
            ...
            Toast.makeText(DonateOnEvent.this, "Contact Number Is Invalid", Toast.LENGTH_SHORT).show();
        }
    }
