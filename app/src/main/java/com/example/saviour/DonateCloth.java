...
public class DonateCloth extends AppCompatActivity implements View.OnClickListener{
    ...
    TextView cUserName, cPhoneNumber, cPlaceName, cClothType, cCityName, cAreaName;
    ImageView callImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cUserName=(TextView)findViewById(R.id.TextView4);
        cPhoneNumber=(TextView)findViewById(R.id.TextView7);
        cPlaceName=(TextView)findViewById(R.id.TextView5);
        cClothType=(TextView)findViewById(R.id.TextView1);
        cCityName=(TextView)findViewById(R.id.TextView2);
        cAreaName=(TextView)findViewById(R.id.TextView3);
        ...
        cPlaceName.setText(placename);
        cUserName.setText(username);
        cPhoneNumber.setText(contact);
        cClothType.setText(type);
        cCityName.setText(cityname);
        cAreaName.setText(areaname);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.fabMain:
                ...
                break;
            case R.id.fabOne:
                Intent a=new Intent(DonateCloth.this,MainActivity.class);
                a.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(a);
                break;

            case R.id.fabTwo:
                Intent b=new Intent(DonateCloth.this,GiveADonation.class);
                b.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(b);
                break;

            case R.id.fabThree:
                Intent c=new Intent(DonateCloth.this,AskForADonation.class);
                c.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(c);
                break;

            case R.id.fabFour:
                Intent d=new Intent(DonateCloth.this,UserProfile.class);
    ...
    private void makePhoneCall() {
        ...
        if (number.length() == 11) {
            ...
            if (ContextCompat.checkSelfPermission(DonateCloth.this,
                    Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(DonateCloth.this,
            ...
            Toast.makeText(DonateCloth.this, "Contact Number Is Invalid", Toast.LENGTH_SHORT).show();
        }
    }
